...
x`
					<ul class="nav navbar-nav mobpad" >
						...
						<a  href="login.html">Team-Quiz <b class="caret"></b></a>
						</li>
						...
						<li class="dropdown static">
						<a href="">Create<b class="caret"></b></a>
						</li>
                        ...
                        <?php//}else{ ?>
                           <!-- <li class="dropdown static">
							<a  href="pages/ambassador_detail" >Campus Ambassador<b class="caret"></b></a>
												...
												<li class="dropdown static"><a href="#signup" data-toggle="modal" data-target="#signup"  >Login</a></li>
											</ul>
	  ...
	  <div class="col-md-4">
		<div class="thumbnail">
			...
			<div class="mask">
				...
				<a href="a.php" class="info" style="border-radius:5px">Continue</a>
	  ...
	  <div class="col-md-4" >
		<div class="thumbnail">
			...
			<div class="mask">
				...
				<p style="color:#FFF;">We excel in organizing quizzes and providing online quizzing platform to Corporates, Institutes, & Individuals.</p>
				 <a href="https://www.quizzinginc.com/event/event_page" class="info" style="border-radius:5px">Continue</a>
			</div>
			</div>
		</div>
	  </div>
		...
		<div class="thumbnail">
		   <div class="view view-fifth" style="border-radius:5px">
			...
			<div class="mask">
				...
				<p style="color:#FFF;">We excel in organizing quizzes and providing online quizzing platform to Corporates, Institutes, & Individuals.</p>
				<a href="http://www.eolympiad.com" class="info" style="border-radius:5px" target="_blank">Continue</a>
			</div>
		  </div>
		</div>
	  </div>
		...
		<div class="thumbnail">
			<div class="view view-fifth" style="border-radius:5px">
				...
				<div class="mask">
					...
					<p style="color:#FFF;">We excel in organizing quizzes and providing online quizzing platform to Corporates, Institutes, & Individuals.</p>
					 <a href="https://www.quizzinginc.com/package/index" class="info" style="border-radius:5px">Continue</a>
				</div>
			</div>                 
		</div>
	  </div>
		...
		<div class="thumbnail">
		 <div class="view view-fifth" style="border-radius:5px">
			...
			<div class="mask">
				...
				<p style="color:#FFF;">We excel in organizing quizzes and providing online quizzing platform to Corporates, Institutes, & Individuals.</p>
				 <a href="https://www.quizzinginc.com/classroom_quiz/index" class="info" style="border-radius:5px">Continue</a>
			</div>
		   </div>
		</div>
	  </div>
	  <div class="col-md-4" style="margin-bottom:15px;">
		<div class="thumbnail">
		 <div class="view view-fifth" style="border-radius:5px">
			<img src="https://www.quizzinginc.com/template/home_design/images/services_bg.png" class="img-responsive img-rounded" >     
			<div class="center" style="padding-top:20%;">
			<div align="center"><img src="https://www.quizzinginc.com/template/home_design/images/entrance_exam.png" width="76" height="48"></div>
			...
			<div class="mask">
				...
				<p style="color:#FFF;">We excel in organizing quizzes and providing online quizzing platform to Corporates, Institutes, & Individuals.</p>
				 <a href="https://www.quizzinginc.com/entrance_exam/index" class="info" style="border-radius:5px">Continue</a>
			</div>
		  </div>
		</div>
	  </div>
